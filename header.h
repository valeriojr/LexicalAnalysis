...
enum TokenCategory {Invalid=-1,Assignment, Bool, Character, CloseBraces, CloseBrackets, CloseParenthesis, Comma, Dot, Ellipsis, Else, Float, For, Identifier, If, Integer, OpAdd, OpAnd, OpDiv, OpEq, OpGt, OpGte, OpLt, OpLte, OpMod, OpMul, OpNeq, OpNot, OpOr, OpSub, OpenBraces, OpenBrackets, OpenParenthesis, Return, SemiColon, String, TypeBool, TypeChar, TypeFloat, TypeInt, TypeString, While};
const char TokenCategoryNames[41][20] = {
"Assignment",
"Bool",
"Character",
"CloseBraces",
...
;std::unordered_map<char, int> transitions[42] = {
...
std::unordered_map<char, int>({}),
std::unordered_map<char, int>({}),
std::unordered_map<char, int>({{49, 22}, {50, 22}, {51, 22}, {52, 22}, {53, 22}, {54, 22}, {55, 22}, {56, 22}, {57, 22}}),
std::unordered_map<char, int>({{49, 22}, {50, 22}, {51, 22}, {52, 22}, {53, 22}, {54, 22}, {55, 22}, {56, 22}, {57, 22}}),
std::unordered_map<char, int>({}),
std::unordered_map<char, int>({}),
std::unordered_map<char, int>({}),
...
const TokenCategory stateToken[] = {
Invalid,
OpenParenthesis,
CloseParenthesis,
OpenBrackets,

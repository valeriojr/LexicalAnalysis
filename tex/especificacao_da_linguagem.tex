...
\lstinputlisting[caption=Estrutura básica da linguagem Agoravai, label=lst:estrutura-basica]{estrutura_basica.agrvai}

\input{secoes/especificacao_de_tipos}
\input{secoes/instrucoes}
\input{secoes/funcoes}
\input{secoes/exemplos_programas}